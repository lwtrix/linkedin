...
export const ProfileInformation = () => {
  ...
  return (
    <>
      ...
      <Row className="text-container">
        ...
        <Col className="details" xs={8}>
          ...
          <div className="controls">
            <a href="#" className="open-to">Open to</a>
            <a href="#" className="add-section">Add profile section</a>
      ...
      <ProffesionalBanners />
      <EditProfileModal user={user} show={showEditModal} handleClose={handleClose} />
    </div>
    )}
    </>
